...
import io.github.alexeybond.partly_solid_bicycle.engine.preprocessing.processors.generatePathParse
import io.github.alexeybond.partly_solid_bicycle.engine.preprocessing.processors.nodePathCCN
import javax.lang.model.type.TypeKind
import javax.lang.model.type.TypeMirror

class LoadNodePathGenerator : PropertyOperationGenerator {
    override fun generateOperation(
        ...
        return CodeBlock.builder()
                .add("${args["lvalue"]} = ")
                .add(generatePathParse("${args["rvalue"]}.getString()"))
                .add(";\n")
                .build()
    }
}
