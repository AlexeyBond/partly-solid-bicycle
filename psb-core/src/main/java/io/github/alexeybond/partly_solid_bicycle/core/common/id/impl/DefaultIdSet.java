package io.github.alexeybond.partly_solid_bicycle.core.common.id.impl;

import io.github.alexeybond.partly_solid_bicycle.core.common.id.Id;
import io.github.alexeybond.partly_solid_bicycle.core.common.id.IdSet;
...
public class DefaultIdSet<T> implements IdSet<T> {
    ...
    private final Map<Object, DefaultId> ids = new HashMap<>();
