package com.github.alexeybond.partly_solid_bicycle.game.utils.spriter_animation.impl;
...
public class DrawerImpl extends Drawer<Sprite> {
    private Batch batch;
    private ShapeRenderer renderer;

    public DrawerImpl(Loader<Sprite> loader){
        super(loader);
    }
    ...
    public void draw(Player player, DrawingState state) {
